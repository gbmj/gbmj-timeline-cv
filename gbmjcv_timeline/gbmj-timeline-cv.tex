...
\tightbox{name=cvobjective, column=1, span=9.5, below=cvheader}{Objective}{
    After sixteen rewarding years running my own translation company, I'm eager to return to \cvhilite{computer science research.} My past work is in graphics; my future is in \cvhilite{privacy and security.}
}
...
\posterbox[title=My story, left=3mm, right=3mm]{name=story1, column=6, span=7, below=cvobjective}{
    ...
    \sbvsep{1mm}
    In 1988 I was awarded one of four international student grants to assist NFRA (now ASTRON) staff members in their astronomical research. Those twelve weeks in Dwingeloo produced \cvhilite{three academic papers on radio astronomy imaging.} In late August I went back home to the US and completed my \cvhilite{BSc in mathematics in 1989.}
    \sbvsep{1mm}
...
\sideboxright{name=nfra, column=13, span=6, below=cvphoto}{1988}{6cm}{
    ...
    \sbdescrip{
        Three-month grant to work with Dr. Steffi Baum and Dr. Chris O'Dea at the NFRA on radio astronomy imaging.
    }
    \sbvsep{1mm}
    \cvhilite{Papers}
    \sbvsep{1mm}
...
\posterbox[title=My story continued, left=3mm, right=3mm]{name=story2, column=6, span=7, below=cvheader}{
    ...
    \sbvsep{1mm}
    So that's my story so far. After two decades on the periphery of technology, I'm ready to sink my teeth back into its heart. Over the years I've developed a keen interest in privacy and security. I've taken a handful of MOOCs on cybersecurity and dabbled in Python and ML. My next step is to earn an MSc, then a PhD. So \cvhilite{watch this space...}
}
...
\sideboxbottom{name=future, column=7, span=12, row=17, rowspan=3.1}{2019– . . .}{3.2cm}{
}
